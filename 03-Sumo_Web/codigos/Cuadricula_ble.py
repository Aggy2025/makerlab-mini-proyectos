...
def girar_grados(sensor, grados, drift, velocidad=0.35):

    sentido = 1 if grados > 0 else -1

    objetivo = abs(grados) - 2
        ...
        if raw_bytes:
            ...
            try:
                ...
                if cmd.upper() == "F":
                    ...
                    print("Avanzando hasta intersección")
